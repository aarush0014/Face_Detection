...
class Face_Register:
    def __init__(self):
        ...
        self.input_rno = tk.Entry(self.frame_right_info)
    ...
    def GUI_get_input_name(self):
        if self.input_name.get() != "" and self.input_rno.get() != "":
            self.input_name_char = self.input_name.get()+"_"+self.input_rno.get()
    ...
    def GUI_info(self):
        ...
        tk.Label(self.frame_right_info,
                 font=self.font_step_title,
                 text="Step 2: Input Name And Roll No").grid(row=7, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)
        ...
        self.input_rno.grid(row=9, column=1, sticky=tk.W, padx=0, pady=2)
